...
public class IdentityHashMapDemo {
    public static void main(String[] args) {
       ...
       IdentityHashMap m = new IdentityHashMap();  // uses == (reference)method for reference comparision.
       ...
       System.out.println(m); //{10=kiran, 10=kishore}. Map represents in Symbol {}, Where set []
        ...
        HashMap m1 = new HashMap();  // uses .equals (content) method to identify duplicate keys.
